/**
 * File name: InstrumentDistortionModel.h
...
#ifndef INSTRUEMNT_DISTORTION_MODEL_H
#define INSTRUEMNT_DISTORTION_MODEL_H
...
{
 public:
        InstrumentDistortionModel(PercussionModel *parent);
